        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{route('updateScheduleTitle',$schedule->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="5" class="form-control">{{$schedule['description']}}</textarea></div>
                        </div>
