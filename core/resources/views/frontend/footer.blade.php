<footer>
    ...
    <div class="footer-right-shape">
        <img src="{{asset('assets/frontEnd/assets/images/parallax/parallax10.png')}}" alt="parallax">
    </div>
    <div id="parallax04" class=" d-none d-lg-block">
        <div class="layer" data-depth=".4">
            <img src="{{asset('assets/frontEnd/assets/images/parallax/parallax08.png')}}" alt="parallax">
        </div>
        <div class="layer" data-depth=".4">
            <img src="{{asset('assets/frontEnd/assets/images/parallax/parallax09.png')}}" alt="parallax">
        </div>
    </div>
    <div class="container">
        <div class="footer-top">
            <div class="footer-logo">
                <a href="index.html"><img src="{{asset('assets/frontEnd/assets/images/logo/logo.png')}}" alt="logo"></a>
            </div>
